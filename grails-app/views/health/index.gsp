...
<html>
	...
	<body>
		...
		< id="list-health" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="title" title="${message(code: 'health.title.label', default: 'Title')}" />
					
						<g:sortableColumn property="author" title="${message(code: 'health.author.label', default: 'Author')}" />
						<g:sortableColumn property="message" title="${message(code: 'health.message.label', default: 'Message')}" />

					
						<g:sortableColumn property="category" title="${message(code: 'health.category.label', default: 'Category')}" />

						<g:sortableColumn property="comment" title="${message(code: 'health.comment.label', default: 'Comment')}" />
					
						<g:sortableColumn property="dateCreated" title="${message(code: 'health.dateCreated.label', default: 'Date Created')}" />
